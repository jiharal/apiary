...
func (s *Session) RequesterID() int64 {
...
func SetContextRequesterID(ctx context.Context, id int64) context.Context {
...
func GetContextRequesterID(ctx context.Context) int64 {
	id, _ := ctx.Value(contextRequesterID).(int64)
	return id
}
